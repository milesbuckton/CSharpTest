...
public class RetryPolicyTests
{
    ...
    public void DoOperation_AllAttemptsFail_LogsExhaustedMessage()
    {
        ...
        RetryPolicy policy = new(_mockLogger.Object, 2, _mockServer.Object);
    ...
    {
        _mockServer.Setup(s => s.DoOperation()).Returns(OperationResult.Error("fail"));
        RetryPolicy policy = new(_mockLogger.Object, 3, _mockServer.Object);
    ...
    {
        _mockServer.Setup(s => s.DoOperation()).Returns(OperationResult.Error("fail"));
        RetryPolicy policy = new(_mockLogger.Object, 1, _mockServer.Object);
